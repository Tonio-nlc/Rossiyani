...
type WordSection = "definitions" | "etymology" | "usage" | "conjugation";
...
export function ExplorerWordPane({ presentation, breadcrumb }: ExplorerWordPaneProps) {
  const [section, setSection] = useState<WordSection>("definitions");
  ...
  useEffect(() => {
    const sync = () => {
      const hash = window.location.hash.replace("#", "") as WordSection;
      if (["definitions", "etymology", "usage", "conjugation"].includes(hash)) {
        setSection(hash);
      } else {
  ...
  return (
    <article className="explorer-word">
      ...
      {section === "definitions" ? (
        <section id="definitions" className="explorer-word-section">
          ...
          {presentation.extraExamples.length > 0 ? (
            <div className="explorer-word-section explorer-word-section--archive">
              <h3 className="explorer-word-section__title explorer-word-section__title--subtle">
                Autres exemples
              </h3>
      ...
      {section === "etymology" && presentation.etymology ? (
      ...
      {section === "usage" && presentation.usage ? (
      ...
      {section === "conjugation" && showConjugation ? (
